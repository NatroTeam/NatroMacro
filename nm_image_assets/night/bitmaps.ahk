...
bitmaps["confirm_night"]["grass"] := Gdip_CreateBitmap(10, 10), G := Gdip_GraphicsFromImage(bitmaps["confirm_night"]["grass"]), Gdip_GraphicsClear(G, 0xFF17481F), Gdip_DeleteGraphics(G)
