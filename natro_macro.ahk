...
Gui, Add, Text, x442 y265 gDonateLink, Donate
Gui, Font
...
Gui, Add, DropDownList, x118 y57 w60 vFieldPattern1 gnm_SaveGather, %FieldPattern1%||Lines|Snake|Diamonds|Squares|Typewriter
GuiControl, disable, FieldPattern1
Gui, Add, DropDownList, x118 y115 w60 vFieldPattern2 gnm_SaveGather, %FieldPattern2%||Lines|Snake|Diamonds|Squares|Typewriter
GuiControl, disable, FieldPattern2
Gui, Add, DropDownList, x118 y175 w60 vFieldPattern3 gnm_SaveGather, %FieldPattern3%||Lines|Snake|Diamonds|Squares|Typewriter
...
Gui, Add, DropDownList, x347 y57 w60 vFieldReturnType1 gnm_SaveGather, %FieldReturnType1%||Walk|Reset
GuiControl, disable, FieldReturnType1
Gui, Add, DropDownList, x347 y115 w60 vFieldReturnType2 gnm_SaveGather, %FieldReturnType2%||Walk|Reset
GuiControl, disable, FieldReturnType2
Gui, Add, DropDownList, x347 y175 w60 vFieldReturnType3 gnm_SaveGather, %FieldReturnType3%||Walk|Reset
...
Gui, Add, GroupBox, x255 y23 w240 h214, Stats
Gui, Font
...
Gui, Add, Text, x260 y37 w235 h198 left vstats,
nm_setStatus()
nm_setStats()
...
Gui, Add, Text, x270 y25 w80 left +BackgroundTrans, Bug Run
...
Gui, Add, DropDownList, x70 y60 w45 vMondoAction gnm_saveCollect, %MondoAction%||Buff|Kill
GuiControl, disable, MondoAction
Gui, Add, Checkbox, x15 y85 +BackgroundTrans vAntPassCheck gnm_saveCollect Checked%AntPassCheck%, Ant Pass (free)
...
Gui, Add, Checkbox, x260 y45 w110 +border vGiftedViciousCheck gnm_saveCollect Checked%GiftedViciousCheck%, Apply Hive Bonus:`nGifted Vicious Bee
Gui, Add, text, x260 y75 +BackgroundTrans, Loot
Gui, Add, text, x295 y75 +BackgroundTrans, Kill
Gui, Add, text, x260 y77 +BackgroundTrans, _ _ _ _ _ _ _ _ _ _ _ _
Gui, Add, text, x285 y75 +BackgroundTrans, !
Gui, Add, text, x285 y85 +BackgroundTrans, !
Gui, Add, text, x285 y105 +BackgroundTrans, !
Gui, Add, text, x285 y125 +BackgroundTrans, !
Gui, Add, text, x285 y145 +BackgroundTrans, !
Gui, Add, text, x285 y165 +BackgroundTrans, !
Gui, Add, text, x285 y185 +BackgroundTrans, !
Gui, Add, Checkbox, x266 y95 +BackgroundTrans vBugrunLadybugsLoot  gnm_saveCollect Checked%BugrunLadybugsLoot%, %A_Space%!
GuiControl, disable, BugrunLadybugsLoot
Gui, Add, Checkbox, x266 y115 +BackgroundTrans vBugrunRhinoBeetlesLoot gnm_saveCollect Checked%BugrunRhinoBeetlesLoot%, %A_Space%!
GuiControl, disable, BugrunRhinoBeetlesLoot
Gui, Add, Checkbox, x266 y135 +BackgroundTrans vBugrunSpiderLoot gnm_saveCollect Checked%BugrunSpiderLoot%, %A_Space%!
GuiControl, disable, BugrunSpiderLoot
Gui, Add, Checkbox, x266 y155 +BackgroundTrans vBugrunMantisLoot gnm_saveCollect Checked%BugrunMantisLoot%, %A_Space%!
GuiControl, disable, BugrunMantisLoot
Gui, Add, Checkbox, x266 y175 +BackgroundTrans vBugrunScorpionsLoot gnm_saveCollect Checked%BugrunScorpionsLoot%, %A_Space%!
GuiControl, disable, BugrunScorpionLoot
Gui, Add, Checkbox, x266 y195 +BackgroundTrans vBugrunWerewolfLoot gnm_saveCollect Checked%BugrunWerewolfLoot%, %A_Space%!
GuiControl, disable, BugrunWerewolfLoot
Gui, Add, Checkbox, x294 y95 +BackgroundTrans vBugrunLadybugsCheck gnm_saveCollect Checked%BugrunLadybugsCheck%, Ladybugs
GuiControl, disable, BugrunLadybugsCheck
Gui, Add, Checkbox, x294 y115 +BackgroundTrans vBugrunRhinoBeetlesCheck gnm_saveCollect Checked%BugrunRhinoBeetlesCheck%, Rhino Beetles
GuiControl, disable, BugrunRhinoBeetlesCheck
Gui, Add, Checkbox, x294 y135 +BackgroundTrans vBugrunSpiderCheck gnm_saveCollect Checked%BugrunSpiderCheck%, Spider
GuiControl, disable, BugrunSpiderCheck
Gui, Add, Checkbox, x294 y155 +BackgroundTrans vBugrunMantisCheck gnm_saveCollect Checked%BugrunMantisCheck%, Mantis
GuiControl, disable, BugrunManticCheck
Gui, Add, Checkbox, x294 y175 +BackgroundTrans vBugrunScorpionsCheck gnm_saveCollect Checked%BugrunScorpionsCheck%, Scorpions
GuiControl, disable, BugrunScorpionsCheck
Gui, Add, Checkbox, x294 y195 +BackgroundTrans vBugrunWerewolfCheck gnm_saveCollect Checked%BugrunWerewolfCheck%, Werewolf
...
;Gui, Add, Checkbox, x393 y115 +BackgroundTrans vKingBeetleBabyCheck , %A_Space%!
...
Gui, Add, Button, x20 y170 w90 h30 vAutoFieldBoostButton gnm_autoFieldBoostButton, %buttonText%
...
Gui, Font, w700
Gui, Add, GroupBox, x5 y25 w150 h135, Polar Bear
Gui, Font
Gui, Add, Checkbox, x80 y25 vPolarQuestCheck gnm_savequest Checked%PolarQuestCheck%, Enable
Gui, Add, Text, x10 y40 w150 h120 vPolarQuestProgress +border, %PolarQuestProgress%
...
Gui, Add, Button, x380 y200 w90 h20 gba_showPlanterTimers, Show Timers
...
nm_setStats(){
	...
	delta:=0
	if(MacroRunning) {
		SessionRuntime:=PausedRuntime+nowUnix()-MacroStartTime
		delta:=(nowUnix()-MacroStartTime)
	}
	statsString:=("TotalRuntime: " nm_TimeFromSeconds(TotalRuntime+delta) . tab . "SessionRuntime: " . nm_TimeFromSeconds(SessionRuntime))
...
nm_FieldDefaults(num){
	GuiControl, ChooseString, FieldPattern%num%, Lines
	GuiControl, ChooseString, FieldPatternSize%num%, M
	GuiControl, ChooseString, FieldPatternReps%num%, 3
	GuiControl, ChooseString, FieldPatternShift%num%, 0
	GuiControl, ChooseString, FieldUntilMins%num%, 60
...
nm_toAnyBooster(){
	...
	loop 3 {
		...
		;Blue Field Booster
		if(FieldBooster%A_Index%="blue" && (nowUnix()-LastBlueBoost)>3600 && (nowUnix()-LastBooster)>(FieldBoosterMins*60)){
			nm_toBooster("blue")
		}
		;Red Field Booster
		else if(FieldBooster%A_Index%="red" && (nowUnix()-LastRedBoost)>3600 && (nowUnix()-LastBooster)>(FieldBoosterMins*60)){
			nm_toBooster("red")
		}
...
nm_walkToCollect(){
	...
	global AntPassCheck
	global LastAntPass
	if(AntPassCheck  && (nowUnix()-LastAntPass)>7200){ ;2 hours
		loop, 2 {
			nm_Reset()
			nm_setStatus("Traveling", "Ant Pass")
			nm_Move(9000*MoveSpeedFactor, LeftKey)
			send {%FwdKey% down}
			send {space down}
			sleep, 200
	...
	if(BlueberryDisCheck  && (nowUnix()-LastBlueberryDis)>14400){ ;4 hours
		loop, 2 {
			nm_Reset()
			;nm_setObjective("Blueberry Dispenser")
		...
		if((TunnelBearCheck)  && (nowUnix()-LastTunnelBear)>floor(172800*(1-GiftedViciousCheck*.15))){ ;48 hours
			loop 2 {
				...
				If (MoveMethod="walk") {
					...
					loop 3 {
						sleep 1000
						if(nm_imgSearch("planterConfirm3.png",25,"high")[1] = 0){
							found:=1
							break
						} else {
							nm_Move(250*MoveSpeedFactor, FwdKey)
...
nm_cannonToCollect(){
	...
	if(RoyalJellyDisCheck  && (nowUnix()-LastRoyalJellyDis)>(79200)){ ;22 hours
		loop, 2 {
			nm_Reset()
...
nm_GoGather(){
	...
	GuiControlGet, FieldPatternReps%CurrentFieldNum%
	GuiControlGet, FieldPatternShift%CurrentFieldNum%
	GuiControlGet, FieldUntilMins%CurrentFieldNum%
	...
	while((BackpackPercentFiltered<FieldUntilPack%CurrentFieldNum%) && ((nowUnix()-gatherStart)<(FieldUntilMins%CurrentFieldNum%*60))){
		...
		;interrupt if...
		if(DisconnectCheck() || youDied || not nm_activeHoney() || VBState=1) {
			bypass:=1
			break
		}
		if(MondoBuffCheck && A_Min>=0 && A_Min<14 && (nowUnix()-LastMondoBuff)>960){
...
nm_PolarQuestProg(){
	...
	imgPos := nm_imgSearch("polar_bear.png",10, "highleft")
	imgPos2 := nm_imgSearch("polar_bear2.png",10, "highleft")
...
nm_PolarQuest(){
	...
	;do quest stuff
	while(QuestGatherField!="None" || (QuestLadybugs && (nowUnix()-LastBugrunLadybugs)>floor(300*(1-GiftedViciousCheck*.15))) || (QuestRhinoBeetlesbugs && (nowUnix()-LastBugrunRhinoBeetles)>floor(300*(1-GiftedViciousCheck*.15))) || (QuestSpider && (nowUnix()-LastBugrunSpider)>floor(1800*(1-GiftedViciousCheck*.15))) || (QuestMantis && (nowUnix()-LastBugrunMantis)>floor(1200*(1-GiftedViciousCheck*.15))) || (QuestScorpions && (nowUnix()-LastBugrunScorpions)>floor(1200*(1-GiftedViciousCheck*.15))) || (QuestWerewolf && (nowUnix()-LastWerewolf)>floor(3600*(1-GiftedViciousCheck*.15)))){
		nm_Bugrun()
		nm_PolarQuestProg()
...
nm_questGather(){
	...
	;reset
	nm_Reset()
	objective:=("Quest: " . QuestGatherField)
	nm_gotoRamp()
	;goto field
	if(MoveMethod="Walk"){
	...
	nm_setStatus("Gathering")
	gatherStart:=nowUnix()
	while((BackpackPercentFiltered<100) && ((nowUnix()-gatherStart)<(1800))){
		nm_gather("squares",, 3)
		nm_fieldDriftCompensation()
		nm_PolarQuestProg()
		;interrupt if
		if (thisfield!=QuestGatherField || QuestGatherField="none" || PolarQuestComplete){ ;change fields or this field is complete
...
ba_harvestPlanter(planterNum){
	...
	if (findPlanter && (planterConfirm1[1]=0 || planterConfirm2[1]=0 || planterConfirm3[1]=0)){
		...
		if (findPlanter[1] = 1){
			...
			;gather loot
			;nm_setState("Looting")
			;nm_setObjective(planterName .  " Loot")
			nm_setStatus("Looting", planterName . " Loot")
			;statusUpdate("Gathering "  . planterName .  " Loot")
			sleep, 4000
			nm_Move(1500*MoveSpeedFactor, BackKey, RightKey)
			nm_loot(2000, 5, "left")
			;gatherLoot_()
...
global BackpackPercentFiltered
;auto field boost
if (AFBrollingDice && not disableDayorNight)
    nm_fieldBoostDice()
;death check
