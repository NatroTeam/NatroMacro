...
gui, ptimers:add, text,x322 y-1 w1 +left +BackgroundTrans,|
gui, ptimers:add, text,x322 y09 w1 +left +BackgroundTrans,|
gui, ptimers:add, text,x322 y19 w1 +left +BackgroundTrans,|
gui, ptimers:add, text,x322 y29 w1 +left +BackgroundTrans,|
gui, ptimers:add, text,x322 y39 w1 +left +BackgroundTrans,|
gui, ptimers:add, text,x322 y49 w1 +left +BackgroundTrans,|
gui, ptimers:add, text,x322 y59 w1 +left +BackgroundTrans,|
gui, ptimers:add, text,x322 y69 w1 +left +BackgroundTrans,|
gui, ptimers:add, text,x322 y79 w1 +left +BackgroundTrans,|
gui, ptimers:add, text,x322 y89 w1 +left +BackgroundTrans,|
...
gui ptimers:add, text,x326 y22 w185 +left +BackgroundTrans,. . . . . . . .
gui ptimers:add, text,x326 y57 w185 +left +BackgroundTrans,. . . . . . . . 
