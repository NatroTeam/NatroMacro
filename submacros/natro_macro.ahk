...
nm_BoostedFieldSelectButton(*){
	...
	BoostedFieldSelectGui.Add("Text", "x10 y135", "Other")
...
nm_toAnyBooster(){
	...
	static blueBoosterFields:=["Stump", "Pine Tree", "Bamboo", "Blue Flower"], redBoosterFields:=["Pepper", "Rose", "Strawberry", "Mushroom"], mountainBoosterfields:=["Cactus", "Pumpkin", "Pineapple", "Spider", "Clover", "Dandelion", "Sunflower"], coconutBoosterfields:=["Coconut"]
	...
	loop 3 {
		...
		LastBooster:=max(LastBlueBoost, LastRedBoost, LastMountainBoost, (BoostChaserCheck && CoconutBoosterCheck && CoconutDisCheck) ? LastCoconutDis : 1)
		;Blue Field Booster
		if((FieldBooster%A_Index%="blue" && (nowUnix()-LastBlueBoost)>2700 && (nowUnix()-LastBooster)>(FieldBoosterMins*45)) || (QuestBlueBoost && (nowUnix()-LastBlueBoost)>2700)){
			nm_updateAction("Booster")
			nm_toBooster("blue")
		}
		;Red Field Booster
		else if((FieldBooster%A_Index%="red" && (nowUnix()-LastRedBoost)>2700 && (nowUnix()-LastBooster)>(FieldBoosterMins*45)) || (QuestRedBoost && (nowUnix()-LastRedBoost)>2700)){
			nm_updateAction("Booster")
			nm_toBooster("red")
		}
		;Mountain Top Field Booster
		else if(FieldBooster%A_Index%="mountain"  && (nowUnix()-LastMountainBoost)>2700 && (nowUnix()-LastBooster)>(FieldBoosterMins*45)){
			nm_updateAction("Booster")
