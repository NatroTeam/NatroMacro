...
settings["StickerPrinterEgg"] := {"enum": 65, "type": "str", "section": "Boost", "regex": "i)^(Basic|Gold)$"}
...
settings["StickerPrinterCheck"] := {"enum": 269, "type": "int", "section": "Boost", "regex": "i)^(0|1)$"}
settings["LastStickerPrinter"] := {"enum": 270, "type": "int", "section": "Boost", "regex": "i)^\d{1,10}$"}
